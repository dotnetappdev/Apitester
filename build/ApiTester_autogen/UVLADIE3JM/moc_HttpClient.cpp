...
QT_MOC_LITERAL(4, 38, 10), // "statusCode"
QT_MOC_LITERAL(5, 49, 12), // "responseTime"
QT_MOC_LITERAL(6, 62, 7), // "headers"
QT_MOC_LITERAL(7, 70, 15), // "requestFinished"
QT_MOC_LITERAL(8, 86, 15) // "onReplyFinished"

    },
    "HttpClient\0responseReceived\0\0response\0"
    "statusCode\0responseTime\0headers\0"
    "requestFinished\0onReplyFinished"
};
...
void HttpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (HttpClient::*)(const QString & , int , qint64 , const QString & );
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HttpClient::requestFinished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void HttpClient::responseReceived(const QString & _t1, int _t2, qint64 _t3, const QString & _t4)
{
...
// SIGNAL 1
void HttpClient::requestFinished()
{
